...
(function () {
  ...
  async function handleLogin(e) {
    ...
    // FAKE LOGIN START
    setTimeout(() => {
      localStorage.setItem(TOKEN_KEY, 'fake-token-12345');
      localStorage.setItem(EMAIL_KEY, email || 'fakeuser@example.com');
      hideModal();
  ...
  async function isTokenValid(token) {
    if (token === 'fake-token-12345') return true; // FAKE TOKEN VALIDATION
    try {
